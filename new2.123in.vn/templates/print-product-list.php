...
function renderProductCates(PageArray $items)
{
   ...
   $out .= "<li class='uk-active' data-uk-filter-control><a href='#'>Tất cả</a></li>"; //Thêm trước
   foreach ($items as $item) {
      $out .= "<li data-uk-filter-control><a href='#'>$item->title</a></li> ";
   }
...
<div class="uk-container uk-container-expand">
	<div class="uk-grid uk-grid-medium uk-flex uk-flex-middle" data-uk-grid>
		<div class="uk-width-auto">
			<a href="#" class="uk-logo" title=""><img src="<?= pathToAsset()?>img/logo.svg" alt=""></a>
		</div>
		<div class="uk-width-expand">
			<form id="search-form" action="">
				<div class="uk-inline uk-width-1-1">
								...
								<a href="#" class="search-filter" data-uk-filter-control="[data-tags*='']" hidden>Tìm</a>
				</div>
			</form>
		</div>
		<div class="uk-width-auto">
			<ul class="uk-subnav" data-uk-margin>
				<li><a href="#">Yêu cầu chào giá</a></li>

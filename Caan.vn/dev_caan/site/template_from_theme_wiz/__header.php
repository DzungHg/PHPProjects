...
<html lang="en">
<head>
	<title>Công Ty TNHH Ca An Tech</title>
	<meta charset="utf-8">
					...
					<div class="d-flex align-items-center">
						...
						<div class="dropdown">
						  ...
						  <div class="dropdown-menu mt-2 shadow" aria-labelledby="dropdownLanguage">
						    ...
						    <a class="dropdown-item" href="#"><img class="dropdown-item-icon" src="assets/images/flags/sp.svg" alt=""> English</a>						    
						  </div>
						</div>
						<!-- Top info -->
		...
		<nav class="navbar navbar-expand-lg">
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarCollapse">
					...
					<!-- Lấy từ Menu item 6 Docs-->
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="docMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dịch Vụ</a>
							<ul class="dropdown-menu" aria-labelledby="docMenu">
								<li> <a class="dropdown-item" href="https://wizixo.webestica.com/documentation/">Giải Pháp In</a> </li>
								<li> <a class="dropdown-item" href="https://wizixo.webestica.com/documentation/#getting-started-section">Marketing Trực Tiếp</a> </li>								
								<li> <a class="dropdown-item" href="https://wizixo.webestica.com/documentation/#edit-section">Trang Trí Cuộc Sống</a> </li>
								<li> <a class="dropdown-item" href="https://wizixo.webestica.com/documentation/#faqs">Tích Hợp In Dữ Liệu Biến Đổi</a> </li>
								<li class="dropdown-divider"></li>
								<li> <a class="dropdown-item" href="http://support.webestica.com/" target="_blank">Liên Hệ</a> </li>
							</ul>
						</li>
					</ul>

...
/*
Hàm này độ từ hàm trên thành thành liệt kê tóm tắt chi tiết sản phẩm
 */
function ukSanPhamSum(Page $page, $options = array())
{
...
/*
Hàm dưới độ lại hàm trên dùng cho sản phẩm
 */
function ukSanPhamSums(PageArray $sanPhams, $options = array())
{
	if (!$sanPhams->count) {
		if (input()->pageNum > 1) {
			// redirect to first pagination if accessed at an out-of-bounds pagination

 ...
 * ===============================
 * Date: 2019-04-22 16:32:51
 * Hash: ff08206129b6bd77959344fd117a1ad3
 * 
...
<form id="FormBuilder_lien_he" class="FormBuilderFrameworkBasic FormBuilder InputfieldNoFocus InputfieldFormWidths InputfieldForm" name="lien_he" method="post" action="./" data-colspacing="0">
	...
	<div class="Inputfields">
		<div class="Inputfield Inputfield_ten InputfieldText InputfieldStateRequired InputfieldColumnWidth InputfieldColumnWidthFirst" style="width: 30%;" id="wrap_Inputfield_ten">
			<label class="InputfieldHeader" for="Inputfield_ten">
				<?php echo $labels['ten']; ?><!-- Tên -->
			</label>
			<div class="InputfieldContent">
				<input id="Inputfield_ten" class="required" name="ten" type="text" maxlength="50" required="required" />
			</div>
		</div>
		<div class="Inputfield Inputfield_email InputfieldEmail InputfieldStateRequired InputfieldColumnWidth" style="width: 30%;" id="wrap_Inputfield_email">
			<label class="InputfieldHeader" for="Inputfield_email">
				<?php echo $labels['email']; ?><!-- Email -->
			</label>
			<div class="InputfieldContent">
				<input id="Inputfield_email" name="email" class="required" type="email" maxlength="512" required="required" />
			</div>
		</div>
		<div class="Inputfield Inputfield_dien_thoai InputfieldText InputfieldColumnWidth" style="width: 30%;" id="wrap_Inputfield_dien_thoai">
			<label class="InputfieldHeader" for="Inputfield_dien_thoai">
				<?php echo $labels['dien_thoai']; ?><!-- Điện Thoại -->
			</label>
			<div class="InputfieldContent">
				<input id="Inputfield_dien_thoai" name="dien_thoai" type="text" maxlength="2048" />
			</div>
		</div>
		<div class="Inputfield Inputfield_tieu_de InputfieldText" id="wrap_Inputfield_tieu_de">
			<label class="InputfieldHeader" for="Inputfield_tieu_de">
				<?php echo $labels['tieu_de']; ?><!-- Tiêu đề -->
			</label>
			<div class="InputfieldContent">
				<p class="description"><?php echo $descriptions['tieu_de']; ?></p>
				<input id="Inputfield_tieu_de" name="tieu_de" type="text" maxlength="2048" />
			</div>
		</div>
		<div class="Inputfield Inputfield_noi_dung InputfieldTextarea" id="wrap_Inputfield_noi_dung">
			<label class="InputfieldHeader" for="Inputfield_noi_dung">
				<?php echo $labels['noi_dung']; ?><!-- Nội dung -->
			</label>
			<div class="InputfieldContent">
				<textarea id="Inputfield_noi_dung" name="noi_dung" rows="5"></textarea>
			</div>
		</div>
		<div class="Inputfield Inputfield_lien_he_submit InputfieldSubmit" id="wrap_lien_he_submit">
			<div class="InputfieldContent">
				<button type="submit" name="lien_he_submit" value="<?php echo $labels['lien_he_submit']; ?><!-- Gởi đi -->">
					<?php echo $labels['lien_he_submit']; ?><!-- Gởi đi -->
				</button>
			</div>
		</div>
	</div>

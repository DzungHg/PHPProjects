...
<body>
	...
	<?php else : ?>
		...
		<p><?php echo __('Cảm ơn bạn đã gởi thông tin tới 123in. Đây là mail tự động phản hồi. Dưới đây là nội dung bạn gởi cho chúng tôi.'); ?></p>
		...
		<p><small><?php echo __('In Gia Công - 123in'); ?> &bull; <?php echo date('Y/m/d g:ia'); ?></small></p>

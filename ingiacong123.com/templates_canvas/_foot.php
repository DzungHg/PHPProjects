		...
		<footer id="footer" class="dark noborder">
					...
					<div class="row divcenter clearfix">
						...
						<div class="col-lg-4">
							...
							<div class="widget clearfix">
								...
								<p class="lead">123 Cộng Hòa, P. 4, Tân Bình<br>TPHCM, Việt Nam</p>
			...
			<div id="copyrights">
				<div class="container center clearfix">
					Copyright 123in/Ca An 2019 | All Rights Reserved
				</div>
			</div>
	...
	<script src="<?php echo $config->urls->templates; ?>assets/js/plugins.js"></script>
				...
				markers: [
					{
						...
						icon: {
							image: "<?php echo $config->urls->templates; ?>assets/images/icons/map-icon-red.png",
							iconsize: [32, 32],
							iconanchor: [14,44]
						}
					}

...
<head>
	...
	<!-- Favicon -->
	<link rel="shortcut icon" href="<?php echo $config->urls->templates; ?>assets/images/favicon.ico">
			...
			<div class="container">
				<div class="row position-relative">
					<div class="col-md-8 mx-auto py-5">
						...
						<p class="small mt-2 mb-0"><strong>e.g.</strong>CA AN </p>
					</div>
			...
			<div class="container">
				<div class="d-flex justify-content-between align-items-center">
					...
					<div class="d-flex align-items-center">
						<!-- Language -->
						<div class="dropdown">
							<a class="dropdown-toggle" href="#" role="button" id="dropdownLanguage" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img class="dropdown-item-icon" src="<?php echo $config->urls->templates; ?>assets/images/flags/vn.svg" alt=""> Tiếng Việt </a>
							<div class="dropdown-menu mt-2 shadow" aria-labelledby="dropdownLanguage">
								<span class="dropdown-item-text">Chọn ngôn ngữ</span>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="#"><img class="dropdown-item-icon" src="<?php echo $config->urls->templates; ?>assets/images/flags/uk.svg" alt=""> English</a>
							</div>
						</div>
						<!-- Top info -->
						<ul class="nav list-unstyled ml-3">
							<li class="nav-item mr-3">
								<a class="navbar-link" href="#"><strong>ĐT:</strong> (+84-28) 38623700</a>
							</li>
							<li class="nav-item mr-3">
								<a class="navbar-link" href="#"><strong>Email:</strong> info[]caan.com.vn</a>
							</li>
						</ul>
					</div>
					...
					<div class="d-flex align-items-center">
						...
						<ul class="nav">
							<li class="nav-item">
								<a class="nav-link" href="\thong-tin\lien-he">Liên Hệ</a>
							</li>
						</ul>
						<!-- top social -->

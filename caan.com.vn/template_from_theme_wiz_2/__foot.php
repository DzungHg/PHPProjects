					...
					<div class="widget">
						<a href="/" class="footer-logo">
							...
							<svg class="navbar-brand-item" width="156" height="40" viewBox="0 0 2356 602" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;">
								...
								<g transform="matrix(1,0,0,1,-1153.61,-812.627)">
									<g>
										<g transform="matrix(4.16667,0,0,4.16667,1755.42,1414.47)">
										...
										<g transform="matrix(4.16667,0,0,4.16667,1454.54,1376.11)">
										...
										<g transform="matrix(4.16667,0,0,4.16667,1454.54,1211.53)">
											<circle cx="0" cy="-23.515" r="23.515" style="fill:rgb(108,110,112);" />
										</g>
										<g transform="matrix(0,-4.16667,-4.16667,-0,3452.62,1043.89)">
											<path d="M10.952,10.705L44.635,10.705L44.635,-10.952L-22.978,-10.952L10.952,10.705Z" style="fill:rgb(0,124,195);fill-rule:nonzero;" />
										</g>
										<g transform="matrix(4.16667,0,0,4.16667,2492.83,1005.13)">
											<path d="M0,20.959L-11.041,-11.191L-10.967,-11.414L-25.17,-33.669L-24.556,-35.331L2.645,-35.331L36.485,56.29L12.055,56.29L5.712,37.764L-28.253,37.764L-34.595,56.29L-58.415,56.29L-29.564,-21.782L-15.463,0.312L-22.541,20.959L0,20.959Z" style="fill:rgb(0,124,195);fill-rule:nonzero;" />
										</g>
										<g transform="matrix(4.16667,0,0,4.16667,3471.53,857.917)">
											<path d="M0,91.621L-22.767,91.621L-61.647,28.734L-61.647,91.621L-83.303,91.621L-83.303,0L-55.074,0L-36.54,29.113L-36.552,29.113L-30.765,38.183L-21.656,52.491L-21.656,52.456L0,86.386L0,91.621ZM-128.247,56.29L-139.269,24.203L-139.175,23.917L-153.405,1.623L-152.803,0L-125.602,0L-91.766,91.621L-116.193,91.621L-122.535,73.095L-156.5,73.095L-162.843,91.621L-186.663,91.621L-157.795,13.514L-143.698,35.604L-150.788,56.29L-128.247,56.29Z" style="fill:rgb(0,124,195);fill-rule:nonzero;" />
										</g>
										<g transform="matrix(4.16667,0,0,4.16667,2084.55,850.475)">
											<path d="M0,95.193C-6.804,95.193 -13.088,94.184 -18.863,92.169C-24.618,90.173 -29.575,87.168 -33.711,83.201C-37.851,79.21 -41.063,74.249 -43.352,68.306C-45.621,62.343 -46.756,55.476 -46.756,47.682C-46.756,40.436 -45.664,33.84 -43.5,27.939C-41.317,22.035 -38.164,16.953 -34.028,12.727C-30.037,8.677 -25.099,5.528 -19.219,3.321C-13.338,1.095 -6.91,0 0.063,0C3.928,0 7.395,0.211 10.501,0.633C13.588,1.072 16.468,1.639 19.093,2.335C21.824,3.11 24.325,3.99 26.551,4.961C28.797,5.904 30.749,6.807 32.431,7.625L32.431,29.849L29.72,29.849C28.589,28.863 27.138,27.685 25.393,26.339C23.652,24.977 21.676,23.651 19.449,22.329C17.204,21.026 14.747,19.915 12.121,19.011C9.496,18.107 6.698,17.669 3.697,17.669C0.379,17.669 -2.77,18.17 -5.779,19.222C-8.78,20.271 -11.531,22.012 -14.093,24.43C-16.511,26.762 -18.464,29.868 -19.954,33.714C-21.465,37.576 -22.2,42.24 -22.2,47.745C-22.2,53.501 -21.402,58.29 -19.786,62.155C-18.147,65.997 -16.112,69.041 -13.651,71.248C-11.155,73.517 -8.361,75.114 -5.294,76.08C-2.203,77.047 0.818,77.528 3.823,77.528C6.698,77.528 9.535,77.109 12.352,76.248C15.165,75.388 17.747,74.21 20.122,72.739C22.138,71.541 24.008,70.258 25.729,68.916C27.455,67.57 28.859,66.396 29.974,65.41L32.431,65.41L32.431,87.317C30.143,88.346 27.936,89.312 25.854,90.216C23.757,91.116 21.57,91.895 19.262,92.548C16.28,93.405 13.463,94.058 10.838,94.52C8.213,94.962 4.601,95.193 0,95.193" style="fill:rgb(0,124,195);fill-rule:nonzero;" />
										</g>
										<g transform="matrix(1,0,0,1,-152.515,-514.606)">
											<text x="2078.91px" y="1897.52px" style="font-family:'ArialMT', 'Arial', sans-serif;font-size:158.814px;fill:rgb(50,50,50);">Giải Pháp In Hiệu Quả</text>
										</g>
									</g>
								</g>
							</svg>
	...
	<div class="footer-copyright py-3">
		<div class="container">
			<div class="d-md-flex justify-content-between align-items-center py-3 text-center text-md-left">
				<!-- copyright text -->
				<div class="copyright-text">©2019 Bản Quyền <a href="#!"> Ca An.</a></div>
				<!-- copyright links-->
...
<script src="<?php echo $config->urls->templates; ?>assets/vendor/popper.js/umd/popper.min.js"></script>
<script src="<?php echo $config->urls->templates; ?>assets/vendor/bootstrap/dist/js/bootstrap.min.js"></script>
<script src="<?php echo $config->urls->templates; ?>assets/vendor/jquery-easing/jquery.easing.min.js"></script>

<!--Vendors-->
<script src="<?php echo $config->urls->templates; ?>assets/vendor/fancybox/js/jquery.fancybox.min.js"></script>
<script src="<?php echo $config->urls->templates; ?>assets/vendor/owlcarousel/js/owl.carousel.min.js"></script>
<script src="<?php echo $config->urls->templates; ?>assets/vendor/swiper/js/swiper.js"></script>
<script src="<?php echo $config->urls->templates; ?>assets/vendor/wow/wow.min.js"></script>

<!--Template Functions-->
<script src="<?php echo $config->urls->templates; ?>assets/js/functions.js"></script>

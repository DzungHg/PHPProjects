		...
		<div class="swiper-wrapper">
			...
			foreach ($page->feature_matrix as $item) {
				if ($item->type == 'home_master_slide') {
					...
					$teasingText = $item->slide_teasing_text;
						...
						<div class='container h-100'>
							<div class='row d-flex h-100'>
								<div class='col-lg-8 col-xl-6 mr-auto slider-content justify-content-center align-self-center align-items-start text-left'>
									...
									<div class='animated fadeInUp mt-3 dealy-1500'><a href='$linkToPage' class='btn btn-grad'>$buttonLabel</a> <a href='$linkToPage' class='btn btn-link text-white'></a>Chi tiết!</a></div>
								</div>
							</div>
						</div>
					</div>

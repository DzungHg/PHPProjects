...
<body>
	...
	<?php else : ?>
		...
		<p><?php echo __('Cảm ơn bạn đã gởi thông điệp tới Ca An. Đây là email tự động từ hệ thống. Dưới đây là những gì bạn gởi tới chúng tôi.'); ?></p>
		...
		<p><small><?php echo __('Từ Ca An'); ?> &bull; <?php echo date('Y/m/d g:ia'); ?></small></p>

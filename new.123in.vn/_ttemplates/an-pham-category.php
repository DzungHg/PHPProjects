...
//Items là các trang về sản phẩm có chứa danh mục
function renderAnPhamTheoDanhMuc(PageArray $items)
{
   ...
   <div id="page-menu" class="no-sticky">
      ...
      <div id="page-menu-wrap">
         ...
         <div class="container clearfix">
            ...
            <div class="menu-title">LOẠI <span><?php $page->title ?></span> </div>

            <nav>
               <ul>
                  <?php //Render toàn bộ danh mục sản phẩm
      ...
      <div class="content-wrap">
         ...
         <div class="container clearfix">
            ...
            <div id="portfolio" class="portfolio grid-container portfolio-2 clearfix">
               <?php //Render toàn bộ sản phẩm với danh mục bằng page hiện tại. chú ý select=
               $items = $pages->get('/an-pham/danh-sach-an-pham/')->children("print_product_categories=$page");
               echo renderAnPhamTheoDanhMuc($items);
               ?>
